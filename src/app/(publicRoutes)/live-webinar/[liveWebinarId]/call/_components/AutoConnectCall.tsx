...
const AutoConnectCall = ({
  ...
  const startCall = async () => {
    try {
      ...
      toast.success('Call start successfully')
    } catch (error) {
  ...
  //Call setup & cleanup
  useEffect(() => {
    // Start the call iimmediately on mount
    startCall()
  ...
  return (
    <div className='flex flex-col h-[calc(100vh-80px)] bg-background'>
      ...
      <div className='bg-card border-t border-border p-4'>
        <div className="max-w-3xl mx-auto fl' items-center justify-between flex-wrap gap-3">
