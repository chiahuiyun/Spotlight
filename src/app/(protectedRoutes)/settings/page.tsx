      ...
      <div className='w-full p-6 border border-input rounded-lg bg-background shadow-sm'>
        <div className='flex items-center mb-4'>
          <div className='h-10 w-10 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 flex items-center justify-center mr-4'>
            ...
            >
              <path
                d='M12 2L15.09 8.26L22 9.27L17 14.14L18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z'
                fill='white'
              />
            </svg>
          </div>
        ...
        {!isConnected && (
          <div className='mt-6 pt-6 border-t border-border'>
            ...
            <ul className='text-sm text-muted-foreground space-y-2'>
              ...
              <li className='flex items-center gap-2'>
                <div className='h-4 w-4 rounded-fullbg-green-100 flex items-center justify-center'>
                  <div className='h-1.5 w-1.5 rounded-full bg-green-500'></div>
                </div>
