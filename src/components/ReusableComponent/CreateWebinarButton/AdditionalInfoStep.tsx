      ...
      <div className="space-y-4">
        ...
        {couponEnabled && (
            <div className="space-y-2">
                <Input id="coupon-code" value={couponCode || ''} onChange={handleCouponCodeChange} placeholder="Paste the code here" className={cn('!bg-background/50 border border-input', errors.couponCode && 'border-red-400 focus-visible:ring-red-400')} 
                />
                {errors.couponCode && (
